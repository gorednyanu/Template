        ...
        <div>
            <section id="portfolio" className="portfolio">
                <div className="container aos-init" data-aos="fade-up">
                    ...
                    <div className="row gy-4 portfolio-container aos-init" data-aos="fade-up" data-aos-delay="200" style={{position: 'relative', height: "1380px"}}>
                        ...
                        <div className="col-lg-4 col-md-6 portfolio-item filter-web" style={{position: 'absolute', left: '360px', top: '0px'}}>
                            <div className="portfolio-wrap">
                        ...
                        <div className="col-lg-4 col-md-6 portfolio-item filter-app" style={{position: "absolute", left: "0px", top: "276px"}}>
                            <div className="portfolio-wrap">
                        ...
                        <div className="col-lg-4 col-md-6 portfolio-item filter-card" style={{position: "absolute", left: "360px", top: "276px"}}>
                            <div className="portfolio-wrap">
                        ...
                        <div className="col-lg-4 col-md-6 portfolio-item filter-web" style={{position: "absolute", left: "0px", top: "552px"}}>
                            <div className="portfolio-wrap">
                        ...
                        <div className="col-lg-4 col-md-6 portfolio-item filter-app" style={{position: 'absolute', left: '360px', top: '552px'}}>
                            <div className="portfolio-wrap">
                        ...
                        <div className="col-lg-4 col-md-6 portfolio-item filter-card" style={{position: 'absolute', left: '0px', top: '828px'}}>
                            <div className="portfolio-wrap">
                        ...
                        <div className="col-lg-4 col-md-6 portfolio-item filter-card" style={{position: "absolute", left: "360px", top: "828px"}}>
                            <div className="portfolio-wrap">
                        ...
                        <div className="col-lg-4 col-md-6 portfolio-item filter-web" style={{position:"absolute", left: '0px', top: "1104px"}}>
                            <div className="portfolio-wrap">
            ...
            <section id="testimonials" className="testimonials">
                ...
                <div className="container aos-init" data-aos="fade-up">
                    ...
                    <div className="testimonials-slider swiper swiper-initialized swiper-horizontal swiper-pointer-events aos-init" data-aos="fade-up" data-aos-delay="200">
                        <div className="swiper-wrapper" id="swiper-wrapper-46101005d84ce58348" aria-live="off"><div className="swiper-slide swiper-slide-duplicate swiper-slide-duplicate-active" role="group" aria-label="5 / 5" style={{width: "696px", marginRight: "40px"}} data-swiper-slide-index="4">
                            ...
                            <div className="swiper-slide swiper-slide-duplicate-next" role="group" aria-label="1 / 5" style={{ width: "696px", marginRight: "40px;" }} data-swiper-slide-index="0">
                                <div className="testimonial-item">
                                    <div className="stars">
                                        <i className="bi bi-star-fill"></i><i className="bi bi-star-fill"></i><i className="bi bi-star-fill"></i><i className="bi bi-star-fill"></i><i className="bi bi-star-fill"></i>
                                    </div>
                            ...
                            <div className="swiper-slide" role="group" aria-label="2 / 5" style={{ width: "696px", marginRight: "40px;" }} data-swiper-slide-index="1">
                                <div className="testimonial-item">
                                    <div className="stars">
                                        <i className="bi bi-star-fill"></i><i className="bi bi-star-fill"></i><i className="bi bi-star-fill"></i><i className="bi bi-star-fill"></i><i className="bi bi-star-fill"></i>
                                    </div>
                            ...
                            <div className="swiper-slide" role="group" aria-label="3 / 5" style={{ width: "696px", marginRight: "40px" }} data-swiper-slide-index="2">
                                <div className="testimonial-item">
                                    <div className="stars">
                                        <i className="bi bi-star-fill"></i><i className="bi bi-star-fill"></i><i className="bi bi-star-fill"></i><i className="bi bi-star-fill"></i><i className="bi bi-star-fill"></i>
                                    </div>
                            ...
                            <div className="swiper-slide swiper-slide-prev" role="group" aria-label="4 / 5" style={{ width: "696px", marginRight: "40px" }} data-swiper-slide-index="3">
                                <div className="testimonial-item">
                                    <div className="stars">
                                        <i className="bi bi-star-fill"></i><i className="bi bi-star-fill"></i><i className="bi bi-star-fill"></i><i className="bi bi-star-fill"></i><i className="bi bi-star-fill"></i>
                                    </div>
                            ...
                            <div className="swiper-slide swiper-slide-active" role="group" aria-label="5 / 5" style={{ width: "696px", marginRight: "40px" }} data-swiper-slide-index="4">
                                <div className="testimonial-item">
                                    <div className="stars">
                                        <i className="bi bi-star-fill"></i><i className="bi bi-star-fill"></i><i className="bi bi-star-fill"></i><i className="bi bi-star-fill"></i><i className="bi bi-star-fill"></i>
                                    </div>
                            ...
                            <div className="swiper-slide swiper-slide-duplicate swiper-slide-next" role="group" aria-label="1 / 5" style={{ width: "696px", marginRight: "40px" }} data-swiper-slide-index="0">
                                <div className="testimonial-item">
                                    <div className="stars">
                                        <i className="bi bi-star-fill"></i><i className="bi bi-star-fill"></i><i className="bi bi-star-fill"></i><i className="bi bi-star-fill"></i><i className="bi bi-star-fill"></i>
                                    </div>
